...
namespace caviar
{
  ...
  namespace shape
  {
    ...
    public:
      ...
      std::vector<Vector<double>> p_3D;            // vertex points of the shape in 3D space
      Vector<double> n_vector, u_vector, v_vector; //  basis vectors of the plane: normal and (u,v)
      ...
      void uv_to_xyz(double u_i, double v_i, Vector<double> &p_i);
      void xyz_to_uv(const Vector<double> &p_i, double &u_i, double &v_i);
