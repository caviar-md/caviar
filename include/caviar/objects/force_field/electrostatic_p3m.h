...
#ifndef CAVIAR_OBJECTS_FORCEFIELD_ELECTROSTATIC_P3M_H
#define CAVIAR_OBJECTS_FORCEFIELD_ELECTROSTATIC_P3M_H
 ...
 * 
 */
class Electrostatic_p3m : public Force_field {
public:
  Electrostatic_p3m (class CAVIAR *);
  ~Electrostatic_p3m () {};
