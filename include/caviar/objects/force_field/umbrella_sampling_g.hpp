...
namespace caviar
{
  ...
  namespace force_field
  {
     ...
     *
     */
    class Umbrella_sampling_g : public Force_field
    {
    public:
      Umbrella_sampling_g(class CAVIAR *);
      ~Umbrella_sampling_g();
    ...
    public:
      ...
      void open_production_files();
      
      void close_production_files();
      ...
      double initial_pulling = 0;
      double pulling_value = 0;
      double final_pulling = 0;
      double pulling_rate = 0.001;

      int fixed_atom_id = -1;
      int moving_atom_id = -1;
      std::vector<int> fixed_atoms_id;
      std::vector<int> moving_atoms_id;
      int fixed_molecule_id = -1;
      int moving_molecule_id = -1;
      std::vector<Vector3d<double>> fixed_atoms_resting_position;
      std::vector<Vector3d<double>> moving_atoms_resting_position;
      std::vector<Vector3d<double>> moving_atoms_initial_position;
      ...
      std::ofstream ofs_summary_distance;

      std::string file_name_data = "o_umbr_";
      std::string file_name_metadata = "o_umbr_metadata";
      std::string file_name_stat = "o_umbr_stat";
      std::string file_name_summary_distance = "summary_distance.txt";
      std::string file_prefix = "umb";

      class writer::Atom_data* writerXYZ = nullptr;
    };
