...
namespace writer
{
  ...
  public:
    ...
    void write_serial(int64_t, double, bool mpi_files = false);  // time_step and time
    ...
    void dump_energy_serial(int64_t, double, bool mpi_files = false); // dump energy to file
    ...
    void dump_temperature_serial(int64_t, double, bool mpi_files = false); // dump temperature to file
    ...
    void dump_pressure_serial(int64_t, double, bool mpi_files = false); // dump pressure to file

    void dump_xyz_serial(int64_t, double, bool mpi_files = false);   // dump positions to file in xyz format.
    ...
    void dump_xyz_ghost_serial(int64_t, double, bool mpi_files = false);      // dump positions to file in xyz format
    ...
    void dump_povray_serial(int64_t, double, bool mpi_files = false); // dump positions to snapshot files in povray format

    void dump_msd_mpi(int64_t, double); //
    void dump_msd_mpi_shared_atoms(int64_t, double); //
    void dump_msd_serial(int64_t, double, bool mpi_files = false); //
