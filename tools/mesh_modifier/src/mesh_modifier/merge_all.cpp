...
namespace mesh_modifier
{
  ...
  void Mesh_modifier::fix_udn_2411_element_labels()
  {
    ...
    {
      if (i != 0)
        previous_size += unv_container[i - 1].udn_2411.size();
  ...
  void Mesh_modifier::fix_udn_2412_element_labels()
  {
    ...
    {
      if (i != 0)
        previous_size += unv_container[i - 1].udn_2412.size();
  ...
  void Mesh_modifier::fix_udn_2412_node_labels()
  {
    ...
    {
      if (i != 0)
        previous_size += unv_container[i - 1].udn_2411.size(); // size of point labels//
  ...
  void Mesh_modifier::fix_udn_2467_element_labels()
  {
    ...
    {
      if (i != 0)
        previous_size += unv_container[i - 1].udn_2467.size();
