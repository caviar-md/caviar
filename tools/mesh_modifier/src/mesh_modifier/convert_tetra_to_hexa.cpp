...
namespace mesh_modifier
{
  ...
  void Mesh_modifier::make_hexa_from_tetra(std::vector<unsigned> &udn_2467_ids)
  {
    ...
    for (unsigned i = 0; i < num_of_2412; ++i)
    {
      ...
      if (udn_2412.record1[1] == 111)
      {
        ...
        auto hl1 = add_hexahedron_to_2412(pl0123, pl023, pl23, pl123, pl012, pl02, pl2, pl12);
        auto hl2 = add_hexahedron_to_2412(pl0123, pl013, pl13, pl123, pl023, pl03, pl3, pl23);
        auto hl3 = add_hexahedron_to_2412(pl0123, pl012, pl12, pl123, pl013, pl01, pl1, pl13);
        auto hl4 = add_hexahedron_to_2412(pl0123, pl023, pl02, pl012, pl013, pl03, pl0, pl01);
        //
        //  add material ids to udn_2467
        //
        if (udn_2467_ids[i] != -1)
  ...
  void Mesh_modifier::remove_label_from_udn_2467(unsigned element_label, unsigned group_id)
  {
    unsigned uci = unv_container.size() - 1;
  ...
  void Mesh_modifier::add_label_to_udn_2467(unsigned element_label, unsigned group_id)
  {
    unsigned uci = unv_container.size() - 1;
  ...
  unsigned Mesh_modifier::add_point_to_2411(Vector<double> &v)
  {
    ...
    int label = 1;
    if (indx > 0)
      label = udn_2411[indx - 1].record1[0] + 1;
  ...
  unsigned Mesh_modifier::add_hexahedron_to_2412(unsigned l1, unsigned l2, unsigned l3, unsigned l4, unsigned l5, unsigned l6, unsigned l7, unsigned l8)
  {
    unsigned uci = unv_container.size() - 1;
    auto &udn_2412 = unv_container[uci].udn_2412;
    udn_2412.push_back(Universal_dataset_number_2412());
