...
namespace caviar
{
  ...
  namespace force_field
  {
    ...
    Magnetic::Magnetic(CAVIAR *fptr) : Force_field{fptr}, amplitude{1.0},
                                       direction{Vector3d<double>{0, 0, 0}}
    {
      FC_OBJECT_INITIALIZE_INFO
      FC_ERR_NOT_IMPLEMENTED
    }

    bool Magnetic::read(caviar::interpreter::Parser *parser)
    {
      FC_OBJECT_READ_INFO
      bool in_file = true;
