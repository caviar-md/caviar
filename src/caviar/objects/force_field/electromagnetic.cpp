...
Electromagnetic::Electromagnetic (CAVIAR *fptr) : Force_field{fptr}, 
...
bool Electromagnetic::read (caviar::interpreter::Parser *parser) {
  FC_OBJECT_READ_INFO
  bool in_file = true;
...
void Electromagnetic::verify_settings() {
  FC_NULLPTR_CHECK(atom_data)
}


void Electromagnetic::calculate_acceleration () {
