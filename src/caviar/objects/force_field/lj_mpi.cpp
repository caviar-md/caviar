...
void Lj_mpi::calculate_acceleration () { // this scheme may make you to only send ghosts with higher ID even in Atom_data class
  ...
  for (unsigned int i=0; i < atom_data -> owned.id.size(); ++i) { // this doesn't need to be reconstructed in every step
